...
<input type='submit' value='수정'/> <input type='button' value='삭제' onclick='location.href="delete.do?no=${member.no }"'/> <input type='button' value='취소' onclick='location.href="list.do"'/>
</form>
